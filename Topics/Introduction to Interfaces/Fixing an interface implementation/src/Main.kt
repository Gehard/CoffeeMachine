...
const val GRAVITY_NORMAL = 1.0
const val STONE_MASS = 0.25

class Stone : PhysicalBody2D {
    override val mass = STONE_MASS

    override val gravityStrength = GRAVITY_NORMAL

    override val velocity = Vector2(0, 0)
